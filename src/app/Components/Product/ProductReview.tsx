...
export default function ProductReview() {
    ...
    return (
        <section className="max-w-6xl flex-col mx-auto rounded-[25px] bg-[#f7f7f7]">
            {/* Header */}
            <div className="flex flex-col justify-between p-14">
                {/* <div className="max-w-6xl flex-col mx-auto"> */}
                    ...
                    <p className="text-[14px] leading-[28px] font-medium text-[#4a4a4a]">
                        ...
                        Please tell your friends about our website. If you need a variety of HTML templates,
                        you may visit Tooplate and Too CSS websites.
                    </p>
